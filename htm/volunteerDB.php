...
session_start();
	...
	if($row = $rs->fetch_assoc()){
		...
		if($mod%4==1){
				...
				echo		"<div class=\"card\">";
				echo		  '<a href="detail.php?index='.$row['title'].'&id_index='.$row['id'].'"><img alt="Avatar" src="../htm/upload/img_banner/'.$row['img_banner'].'" style="width:100%; height:150px;"height:150px;/></a>';
